! function (t, e) {
    "object" == typeof exports && "object" == typeof module ? module.exports = e() : "function" == typeof define &&
        define.amd ? define("tctip", [], e) : "object" == typeof exports ? exports.tctip = e() : t.tctip = e()
}(this, function () {
    return function (t) {
        function e(r) {
        ...
        return e.m = t, e.c = n, e.i = function (t) {
                ...
                l = function (t) {
                    ...
                    return A(e, t), a(e, [{
                            ...
                            value: function (t, e) {
                                ...
                                return this._dom = (0, s.createElement)(t, e), n.appendChild(this.dom)
                            }
                        }, {
                            key: "appendDom",
                            value: function (t, e) {
            ...
            function r(t) {
                document.body ? t && t() : setTimeout(function () {
                    r(t)
                }, 0)
            }
            function i(t, e) {
            ...
            function o(t, e) {
                if (e = e || document, e.getElementsByClassName) return e.getElementsByClassName(t);
                var n = function (t, e) {
                    var n = [],
            ...
            var a = "innerText";
            "firefox" === A() && (e.textKey = a = "textContent"), e.ready = r, e.createElement = i, e.getElementsByClassName =
                o, e.textKey = a
        }, function (t, e, n) {
            "use strict";
                ...
                h = function (t) {
                    ...
                    return A(e, t), a(e, [{
                            ...
                            value: function () {
                                ...
                                default (this.config, this), this._mainBox = new p.
                                default (this.config, this)
                            }
                        }, {
                            key: "show",
                            value: function () {
            ...
            function i(t) {
                t.button || (t.button = s);
                var e = t.button;
                e.imageUrl || (e.id || (e.id = s.id), e.type && (0, A.inArray)(e.type, u) || (e.type = s.type), e.imageUrl =
                    l[e.type][e.id], delete e.type, delete e.id)
            }
            function o(t) {
                ...
                var e = [],
                    ...
                    o = void 0;
                try {
                    for (var a, c = t.list[Symbol.iterator](); !(r = (a = c.next()).done); r = !0) {
                        var u = a.value;
                        if (!u.type) {
                        ...
                        var s = u.type;
                        if (f.hasOwnProperty(s) && (0, A.mergeObject)(u, f[s], !0), n ? u.active = "" : u.active && (n = !
                            0), u.index = e.length, e.push(u), e.length >= 5) break
                    }
                } catch (t) {
                    i = !0, o = t
                } finally {
            ...
            default = function () {
                var t = o + "/version/" + i;
                document.body.appendChild((0, r.createElement)({
                    src: t
                }, "script"))
            };
            var r = n(1),
                    ...
                    return A(e, t), a(e, [{
                            ...
                            value: function () {
                                this.createDom({
                                    ...
                                    href: "javascript:;"
                                }, "a"), this._button = new l(this.config, this)
                            }
                        }]), e
                }(u.
                default),
            ...
            var a = function () {
                ...
                d = function (t) {
                    function e(t, n) {
                        i(this, e);
                        var r = o(this, (e.__proto__ || Object.getPrototypeOf(e)).call(this, t, n));
                        return r._title = void 0, r._bodyBox = void 0, r._footer = void 0, r.genDom(), r
                    }
                    return A(e, t), a(e, [{
                            key: "genDom",
                            value: function () {
                                ...
                                default ({}, this), this._bodyBox = new p.
                                default ({
                                    list: this.config.list
                                }, this), this._footer = new g.
                                default ({}, this)
                            }
                        }]), e
                }(u.
            ...
            var a = function () {
                ...
                h = function (t) {
                    function e(t, n) {
                        i(this, e);
                        var r = o(this, (e.__proto__ || Object.getPrototypeOf(e)).call(this, t, n));
                        return r._iconBox = void 0, r._QRBox = void 0, r._currentItem = void 0, r.genDom(), r
                    }
                    return A(e, t), a(e, [{
                            key: "genDom",
                            value: function () {
                                ...
                                default ({
                                    list: this.config.list
                                }, this), this._QRDetail = new p.
                                default (this.currentItem, this)
                            }
                        }, {
                            key: "currentItem",
                            get: function () {
                                if (!this._currentItem) {
                                    var t = !0,
                                        ...
                                        n = void 0;
                                    try {
                                        for (var r, i = this.config.list[Symbol.iterator](); !(t = (r = i.next()).done); t = !
                                            0) {
                                            var o = r.value;
            ...
            var c = function () {
                ...
                d = function (t) {
                    function e(t, n) {
                        o(this, e);
                        var r = A(this, (e.__proto__ || Object.getPrototypeOf(e)).call(this, t, n));
                        return r._link = void 0, r._emitter = p.
                        default, r.genDom(), r.addEvent(), r
                    }
                    return a(e, t), c(e, [{
                            key: "genDom",
                            value: function () {
                                this.createDom({
                                    className: this.className
                                }, "li"), this._link = new b(this.config, this)
                            }
                        }, {
                            key: "addEvent",
                            value: function () {
                            ...
                            set: function (t) {
                                this.config.active = t, this.className = t ? "tctip-current" : ""
                            }
                        }]), e
                }(s.
                default),
                b = function (t) {
                    function e(t, n) {
                        o(this, e);
                        var r = A(this, (e.__proto__ || Object.getPrototypeOf(e)).call(this, t, n));
                        return r._img = void 0, r._emitter = p.
                        default, r.genDom(), r
                    }
                    return a(e, t), c(e, [{
                            key: "genDom",
                            value: function () {
                                ...
                                }, l.textKey, this.config.name), "a"), this._img = new y(this.config, this)
                            }
                        }, {
                            key: "mouseover",
                            value: function () {
            ...
            var c = function () {
                ...
                b = function (t) {
                    function e(t, n) {
                        o(this, e);
                        var r = A(this, (e.__proto__ || Object.getPrototypeOf(e)).call(this, t, n));
                        return r._qrTitle = void 0, r._qrCode = void 0, r._qrDesc = void 0, r._emitter = g.
                        default, r.genDom(), r.addEvent(), r
                    }
                    return a(e, t), c(e, [{
                            key: "genDom",
                            ...
                            key: "genChildren",
                            value: function () {
                                this._qrTitle = new y({}, this), this._qrCode = new m(this.config, this), this._qrDesc =
                                    new v({
                            ...
                            key: "regenDom",
                            value: function (t) {
                                this._config = t, this.dom.innerHTML = "", this._box = new e(this.config, this)
                            }
                        }]), e
                }(s.
                default),
                ...
                m = function (t) {
                    ...
                    return a(e, t), c(e, [{
                            ...
                            key: "genQR",
                            value: function () {
                                this.config.qrImg ? this.appendDom({
                                    src: this.config.qrImg
                                }, "img") : this.config.qrContent ? this.dom.innerHTML = (0, p.
                                default)(this.config.qrContent) : console.error("没有可展示的二维码")
                            }
                        }]), e
                }(s.
                default),
            ...
            t.exports = function () {
                ...
                return t.toString = function () {
                    ...
                    for (i = 0; i < e.length; i++) {
                        var A = e[i];
                        "number" == typeof A[0] && r[A[0]] || (n && !A[2] ? A[2] = n : n && (A[2] = "(" + A[2] +
                            ") and (" + n + ")"), t.push(A))
                    }
                }, t
            }
            ...
            t.exports = n, n.EventEmitter = n, n.prototype._events = void 0, n.prototype._maxListeners = void 0, n.defaultMaxListeners =
                10, n.prototype.setMaxListeners = function (t) {
                if (!i(t) || t < 0 || isNaN(t)) throw TypeError("n must be a positive number");
                return this._maxListeners = t, this
            }, n.prototype.emit = function (t) {
                var e, n, i, a, c, u;
                if (this._events || (this._events = {}), "error" === t && (!this._events.error || o(this._events.error) && !
                ...
                } else if (o(n)) for (a = Array.prototype.slice.call(arguments, 1), u = n.slice(), i = u.length, c = 0; c <
                        i; c++) u[c].apply(this, a);
                return !0
            }, n.prototype.addListener = function (t, e) {
                var i;
                if (!r(e)) throw TypeError("listener must be a function");
                return this._events || (this._events = {}), this._events.newListener && this.emit("newListener", t, r(e
                    .listener) ? e.listener : e), this._events[t] ? o(this._events[t]) ? this._events[t].push(e) : this
                    ._events[t] = [this._events[t], e] : this._events[t] = e, o(this._events[t]) && !this._events[t].warned &&
                    (i = A(this._maxListeners) ? n.defaultMaxListeners : this._maxListeners, i && i > 0 && this._events[
                    t].length > i && (this._events[t].warned = !0, console.error(
                ...
                if (n = this._events[t], A = n.length, i = -1, n === e || r(n.listener) && n.listener === e) delete this
                        ._events[t], this._events.removeListener && this.emit("removeListener", t, e);
                else if (o(n)) {
                    for (a = A; a-- > 0;) if (n[a] === e || n[a].listener && n[a].listener === e) {
                            i = a;
                            break
                        }
                    if (i < 0) return this;
                    1 === n.length ? (n.length = 0, delete this._events[t]) : n.splice(i, 1), this._events.removeListener &&
            ...
            var r, i, o, A = function () {
                    function t(e, n) {
                        ...
                        return i.getAt = function (t) {
                            ...
                            for (var n = new Array(i.getLength() + e.getLength() - 1), r = 0; r < i.getLength(); r += 1)
                                for (var o = 0; o < e.getLength(); o += 1) n[r + o] ^= A.gexp(A.glog(i.getAt(r)) + A.glog(
                                        e.getAt(o)));
                            return t(n, 0)
                        }, i.mod = function (e) {
                            if (i.getLength() - e.getLength() < 0) return i;
                            for (var n = A.glog(i.getAt(0)) - A.glog(e.getAt(0)), r = new Array(i.getLength()), o = 0; o <
                                i.getLength(); o += 1) r[o] = i.getAt(o);
                    ...
                    var e = function (e, n) {
                        var i = 236,
                            ...
                            m = new Array,
                            v = {}, E = function (t, e) {
                                d = 4 * p + 17, g = function (t) {
                                    for (var e = new Array(t), n = 0; n < t; n += 1) {
                                        e[n] = new Array(t);
                                        for (var r = 0; r < t; r += 1) e[n][r] = null
                                    }
                                    return e
                                }(d), w(0, 0), w(d - 7, 0), w(0, d - 7), M(), R(), B(t, e), p >= 7 && D(t), null == y &&
                                    (y = U(p, h, m)), k(y, e)
                            }, w = function (t, e) {
                                for (var n = -1; n <= 7; n += 1) if (!(t + n <= -1 || d <= t + n)) for (var r = -1; r <=
                                            7; r += 1) e + r <= -1 || d <= e + r || (0 <= n && n <= 6 && (0 == r || 6 ==
                                                r) || 0 <= r && r <= 6 && (0 == n || 6 == n) || 2 <= n && n <= 4 && 2 <=
                                                r && r <= 4 ? g[t + n][e + r] = !0 : g[t + n][e + r] = !1)
                            }, I = function () {
                                ...
                                for (var t = 8; t < d - 8; t += 1) null == g[t][6] && (g[t][6] = t % 2 == 0);
                                for (var e = 8; e < d - 8; e += 1) null == g[6][e] && (g[6][e] = e % 2 == 0)
                            }, M = function () {
                                for (var t = o.getPatternPosition(p), e = 0; e < t.length; e += 1) for (var n = 0; n <
                                        t.length; n += 1) {
                                        var r = t[e],
                                            i = t[n];
                                        if (null == g[r][i]) for (var A = -2; A <= 2; A += 1) for (var a = -2; a <= 2; a +=
                                                    1) A == -2 || 2 == A || a == -2 || 2 == a || 0 == A && 0 == a ? g[r +
                                                        A][i + a] = !0 : g[r + A][i + a] = !1
                                }
                            }, D = function (t) {
                                ...
                                for (var n = h << 3 | e, r = o.getBCHTypeInfo(n), i = 0; i < 15; i += 1) {
                                    var A = !t && 1 == (r >> i & 1);
                                    i < 6 ? g[i][8] = A : i < 8 ? g[i + 1][8] = A : g[d - 15 + i][8] = A
                                }
                                for (var i = 0; i < 15; i += 1) {
                                    var A = !t && 1 == (r >> i & 1);
                                    i < 8 ? g[8][d - i - 1] = A : i < 9 ? g[8][15 - i - 1 + 1] = A : g[8][15 - i - 1] =
                                        A
                                }
                                g[d - 8][8] = !t
                            }, k = function (t, e) {
                                for (var n = -1, r = d - 1, i = 7, A = 0, a = o.getMaskFunction(e), c = d - 1; c > 0; c -=
                                    2) for (6 == c && (c -= 1);;) {
                                        for (var u = 0; u < 2; u += 1) if (null == g[r][c - u]) {
                                                var s = !1;
                                                A < t.length && (s = 1 == (t[A] >>> i & 1));
                                                var l = a(r, c - u);
                                                l && (s = !s), g[r][c - u] = s, i -= 1, i == -1 && (A += 1, i = 7)
                                            }
                                        if (r += n, r < 0 || d <= r) {
                                            r -= n, n = -n;
                                            break
                                ...
                                for (var r = 0, i = 0, A = 0, a = new Array(n.length), c = new Array(n.length), u = 0; u <
                                    n.length; u += 1) {
                                    var s = n[u].dataCount,
                                        l = n[u].totalCount - s;
                                    i = Math.max(i, s), A = Math.max(A, l), a[u] = new Array(s);
                                    for (var f = 0; f < a[u].length; f += 1) a[u][f] = 255 & e.getBuffer()[f + r];
                                    r += s;
                                ...
                                for (var b = 0, f = 0; f < n.length; f += 1) b += n[f].totalCount;
                                for (var y = new Array(b), m = 0, f = 0; f < i; f += 1) for (var u = 0; u < n.length; u +=
                                        1) f < a[u].length && (y[m] = a[u][f], m += 1);
                                for (var f = 0; f < A; f += 1) for (var u = 0; u < n.length; u += 1) f < c[u].length &&
                                            (y[m] = c[u][f], m += 1);
                                return y
                            }, U = function (t, e, n) {
                                for (var r = a.getRSBlocks(t, e), u = c(), s = 0; s < n.length; s += 1) {
                                    var l = n[s];
                                    u.put(l.getMode(), 4), u.put(l.getLength(), o.getLengthInBits(l.getMode(), t)), l.write(
                                        u)
                                }
                                for (var f = 0, s = 0; s < r.length; s += 1) f += r[s].dataCount;
                                if (u.getLengthInBits() > 8 * f) throw new Error("code length overflow. (" + u.getLengthInBits() +
                                        ">" + 8 * f + ")");
                                for (u.getLengthInBits() + 4 <= 8 * f && u.put(0, 4); u.getLengthInBits() % 8 != 0;) u.putBit(!
                                        1);
                                for (;;) {
                        ...
                        return v.addData = function (t, e) {
                            ...
                            if (t < 0 || d <= t || e < 0 || d <= e) throw new Error(t + "," + e);
                            return g[t][e]
                            ...
                            var n = "";
                            n += '<table style="', n += " border-width: 0px; border-style: none;", n +=
                                " border-collapse: collapse;", n += " padding: 0px; margin: " + e + "px;", n += '">', n +=
                                "<tbody>";
                            for (var r = 0; r < v.getModuleCount(); r += 1) {
                                n += "<tr>";
                                for (var i = 0; i < v.getModuleCount(); i += 1) n += '<td style="', n +=
                                        " border-width: 0px; border-style: none;", n += " border-collapse: collapse;",
                                        n += " padding: 0px; margin: 0px;", n += " width: " + t + "px;", n +=
                                        " height: " + t + "px;", n += " background-color: ", n += v.isDark(r, i) ?
                                        "#000000" : "#ffffff", n += ";", n += '"/>';
                                n += "</tr>"
                            }
                            ...
                            t = t || 2, e = "undefined" == typeof e ? 4 * t : e;
                            var n, r, i, o, A, a = v.getModuleCount() * t + 2 * e,
                                c = "";
                            for (A = "l" + t + ",0 0," + t + " -" + t + ",0 0,-" + t + "z ", c += "<svg", c +=
                                ' width="' + a + 'px"', c += ' height="' + a + 'px"', c +=
                                ' xmlns="http://www.w3.org/2000/svg"', c += ">", c += '<path d="', i = 0; i < v.getModuleCount(); i +=
                                1) for (o = i * t + e, n = 0; n < v.getModuleCount(); n += 1) v.isDark(i, n) && (r = n *
                                        t + e, c += "M" + r + "," + o + A);
                        ...
                        return function (t) {
                            for (var e = new Array, i = 0; i < t.length; i += 1) {
                                ...
                                if (o < 128) e.push(o);
                                    ...
                                    var A = n[t.charAt(i)];
                                    "number" == typeof A ? (255 & A) == A ? e.push(A) : (e.push(A >>> 8), e.push(255 &
                                        A)) : e.push(r)
                                }
                            }
                            return e
                    ...
                    var n = {
                        ...
                        MODE_KANJI: 8
                            ...
                            var e = [[], [6, 18], [6, 22], [6, 26], [6, 30], [6, 34], [6, 22, 38], [6, 24, 42], [6, 26,
                                        46], [6, 28, 50], [6, 30, 54], [6, 32, 58], [6, 34, 62], [6, 26, 46, 66], [6,
                                        26, 48, 70], [6, 26, 50, 74], [6, 30, 54, 78], [6, 30, 56, 82], [6, 30, 58, 86], [
                                        6, 34, 62, 90], [6, 28, 50, 72, 94], [6, 26, 50, 74, 98], [6, 30, 54, 78, 102], [
                                        6, 28, 54, 80, 106], [6, 32, 58, 84, 110], [6, 30, 58, 86, 114], [6, 34, 62, 90,
                                        118], [6, 26, 50, 74, 98, 122], [6, 30, 54, 78, 102, 126], [6, 26, 52, 78, 104,
                                        130], [6, 30, 56, 82, 108, 134], [6, 34, 60, 86, 112, 138], [6, 30, 58, 86, 114,
                                        142], [6, 34, 62, 90, 118, 146], [6, 30, 54, 78, 102, 126, 150], [6, 24, 50, 76,
                                        102, 128, 154], [6, 28, 54, 80, 106, 132, 158], [6, 32, 58, 84, 110, 136, 162], [
                            ...
                            return c.getBCHTypeInfo = function (t) {
                                ...
                                for (var n = t([1], 0), r = 0; r < e; r += 1) n = n.multiply(t([1, A.gexp(r)], 0));
                                return n
                                ...
                                for (var e = t.getModuleCount(), n = 0, r = 0; r < e; r += 1) for (var i = 0; i < e; i +=
                                        1) {
                                        for (var o = 0, A = t.isDark(r, i), a = -1; a <= 1; a += 1) if (!(r + a < 0 ||
                                                e <= r + a)) for (var c = -1; c <= 1; c += 1) i + c < 0 || e <= i + c ||
                                                        0 == a && 0 == c || A == t.isDark(r + a, i + c) && (o += 1);
                                        o > 5 && (n += 3 + o - 5)
                                }
                                for (var r = 0; r < e - 1; r += 1) for (var i = 0; i < e - 1; i += 1) {
                                        var u = 0;
                                        t.isDark(r, i) && (u += 1), t.isDark(r + 1, i) && (u += 1), t.isDark(r, i + 1) &&
                                            (u += 1), t.isDark(r + 1, i + 1) && (u += 1), 0 != u && 4 != u || (n += 3)
                                }
                                for (var r = 0; r < e; r += 1) for (var i = 0; i < e - 6; i += 1) t.isDark(r, i) && !t.isDark(
                                            r, i + 1) && t.isDark(r, i + 2) && t.isDark(r, i + 3) && t.isDark(r, i + 4) && !
                                            t.isDark(r, i + 5) && t.isDark(r, i + 6) && (n += 40);
                                for (var i = 0; i < e; i += 1) for (var r = 0; r < e - 6; r += 1) t.isDark(r, i) && !t.isDark(
                                            r + 1, i) && t.isDark(r + 2, i) && t.isDark(r + 3, i) && t.isDark(r + 4, i) && !
                                            t.isDark(r + 5, i) && t.isDark(r + 6, i) && (n += 40);
                                for (var s = 0, i = 0; i < e; i += 1) for (var r = 0; r < e; r += 1) t.isDark(r, i) &&
                                            (s += 1);
                        ...
                        A = function () {
                            ...
                            for (var n = 8; n < 256; n += 1) t[n] = t[n - 4] ^ t[n - 5] ^ t[n - 6] ^ t[n - 8];
                        ...
                        a = function () {
                            var t = [[1, 26, 19], [1, 26, 16], [1, 26, 13], [1, 26, 9], [1, 44, 34], [1, 44, 28], [1,
                                        44, 22], [1, 44, 16], [1, 70, 55], [1, 70, 44], [2, 35, 17], [2, 35, 13], [1,
                                        100, 80], [2, 50, 32], [2, 50, 24], [4, 25, 9], [1, 134, 108], [2, 67, 43], [2,
                                        33, 15, 2, 34, 16], [2, 33, 11, 2, 34, 12], [2, 86, 68], [4, 43, 27], [4, 43,
                                        19], [4, 43, 15], [2, 98, 78], [4, 49, 31], [2, 32, 14, 4, 33, 15], [4, 39, 13,
                                        1, 40, 14], [2, 121, 97], [2, 60, 38, 2, 61, 39], [4, 40, 18, 2, 41, 19], [4,
                                        40, 14, 2, 41, 15], [2, 146, 116], [3, 58, 36, 2, 59, 37], [4, 36, 16, 4, 37,
                                        17], [4, 36, 12, 4, 37, 13], [2, 86, 68, 2, 87, 69], [4, 69, 43, 1, 70, 44], [6,
                                        43, 19, 2, 44, 20], [6, 43, 15, 2, 44, 16], [4, 101, 81], [1, 80, 50, 4, 81, 51], [
                                        4, 50, 22, 4, 51, 23], [3, 36, 12, 8, 37, 13], [2, 116, 92, 2, 117, 93], [6, 58,
                                        36, 2, 59, 37], [4, 46, 20, 6, 47, 21], [7, 42, 14, 4, 43, 15], [4, 133, 107], [
                                        8, 59, 37, 1, 60, 38], [8, 44, 20, 4, 45, 21], [12, 33, 11, 4, 34, 12], [3, 145,
                                        115, 1, 146, 116], [4, 64, 40, 5, 65, 41], [11, 36, 16, 5, 37, 17], [11, 36, 12,
                                        5, 37, 13], [5, 109, 87, 1, 110, 88], [5, 65, 41, 5, 66, 42], [5, 54, 24, 7, 55,
                                        25], [11, 36, 12, 7, 37, 13], [5, 122, 98, 1, 123, 99], [7, 73, 45, 3, 74, 46], [
                                        15, 43, 19, 2, 44, 20], [3, 45, 15, 13, 46, 16], [1, 135, 107, 5, 136, 108], [
                                        10, 74, 46, 1, 75, 47], [1, 50, 22, 15, 51, 23], [2, 42, 14, 17, 43, 15], [5,
                                        150, 120, 1, 151, 121], [9, 69, 43, 4, 70, 44], [17, 50, 22, 1, 51, 23], [2, 42,
                                        14, 19, 43, 15], [3, 141, 113, 4, 142, 114], [3, 70, 44, 11, 71, 45], [17, 47,
                                        21, 4, 48, 22], [9, 39, 13, 16, 40, 14], [3, 135, 107, 5, 136, 108], [3, 67, 41,
                                        13, 68, 42], [15, 54, 24, 5, 55, 25], [15, 43, 15, 10, 44, 16], [4, 144, 116, 4,
                                        145, 117], [17, 68, 42], [17, 50, 22, 6, 51, 23], [19, 46, 16, 6, 47, 17], [2,
                                        139, 111, 7, 140, 112], [17, 74, 46], [7, 54, 24, 16, 55, 25], [34, 37, 13], [4,
                                        ...
                                        46, 16, 4, 47, 17], [8, 152, 122, 4, 153, 123], [22, 73, 45, 3, 74, 46], [8, 53,
                                        23, 26, 54, 24], [12, 45, 15, 28, 46, 16], [3, 147, 117, 10, 148, 118], [3, 73,
                                        45, 23, 74, 46], [4, 54, 24, 31, 55, 25], [11, 45, 15, 31, 46, 16], [7, 146,
                                        116, 7, 147, 117], [21, 73, 45, 7, 74, 46], [1, 53, 23, 37, 54, 24], [19, 45,
                                        15, 26, 46, 16], [5, 145, 115, 10, 146, 116], [19, 75, 47, 10, 76, 48], [15, 54,
                                        24, 25, 55, 25], [23, 45, 15, 25, 46, 16], [13, 145, 115, 3, 146, 116], [2, 74,
                                        46, 29, 75, 47], [42, 54, 24, 1, 55, 25], [23, 45, 15, 28, 46, 16], [17, 145,
                                        115], [10, 74, 46, 23, 75, 47], [10, 54, 24, 35, 55, 25], [19, 45, 15, 35, 46,
                                        16], [17, 145, 115, 1, 146, 116], [14, 74, 46, 21, 75, 47], [29, 54, 24, 19, 55,
                                        25], [11, 45, 15, 46, 46, 16], [13, 145, 115, 6, 146, 116], [14, 74, 46, 23, 75,
                                        47], [44, 54, 24, 7, 55, 25], [59, 46, 16, 1, 47, 17], [12, 151, 121, 7, 152,
                                        122], [12, 75, 47, 26, 76, 48], [39, 54, 24, 14, 55, 25], [22, 45, 15, 41, 46,
                                        16], [6, 151, 121, 14, 152, 122], [6, 75, 47, 34, 76, 48], [46, 54, 24, 10, 55,
                                        25], [2, 45, 15, 64, 46, 16], [17, 152, 122, 4, 153, 123], [29, 74, 46, 14, 75,
                                        47], [49, 54, 24, 10, 55, 25], [24, 45, 15, 46, 46, 16], [4, 152, 122, 18, 153,
                                        123], [13, 74, 46, 32, 75, 47], [48, 54, 24, 14, 55, 25], [42, 45, 15, 32, 46,
                                        16], [20, 147, 117, 4, 148, 118], [40, 75, 47, 7, 76, 48], [43, 54, 24, 22, 55,
                                        25], [10, 45, 15, 67, 46, 16], [19, 148, 118, 6, 149, 119], [18, 75, 47, 31, 76,
                                        48], [34, 54, 24, 34, 55, 25], [20, 45, 15, 61, 46, 16]],
                                e = function (t, e) {
                                    var n = {};
                            ...
                            return n.getRSBlocks = function (t, n) {
                                var r = i(t, n);
                                if ("undefined" == typeof r) throw new Error("bad rs block @ typeNumber:" + t +
                                        "/errorCorrectionLevel:" + n);
                                for (var o = r.length / 3, A = new Array, a = 0; a < o; a += 1) for (var c = r[3 * a +
                                        0], u = r[3 * a + 1], s = r[3 * a + 2], l = 0; l < c; l += 1) A.push(e(u, s));
                                return A
                            }, n
                        }(),
                        c = function () {
                            ...
                            i.getMode = function () {
                                ...
                                for (var e = r, n = 0; n + 2 < e.length;) t.put(o(e.substring(n, n + 3)), 10), n += 3;
                                n < e.length && (e.length - n == 1 ? t.put(o(e.substring(n, n + 1)), 4) : e.length - n ==
                                    2 && t.put(o(e.substring(n, n + 2)), 7))
                            };
                            var o = function (t) {
                                for (var e = 0, n = 0; n < t.length; n += 1) e = 10 * e + A(t.charAt(n));
                                return e
                            }, A = function (t) {
                            ...
                            i.getMode = function () {
                                ...
                                for (var e = r, n = 0; n + 1 < e.length;) t.put(45 * o(e.charAt(n)) + o(e.charAt(n + 1)),
                                        11), n += 2;
                            ...
                            ! function (t, n) {
                                ...
                                if (2 != r.length || (r[0] << 8 | r[1]) != n) throw "sjis not supported."
                            }("友", 38726);
                            var o = {};
                            return o.getMode = function () {
                                return r
                            ...
                            return i.writeByte = function (r) {
                                ...
                                if (e > 0 && (o(t << 6 - e), t = 0, e = 0), n % 3 != 0) for (var i = 3 - n % 3, A = 0; A <
                                        i; A += 1) r += "="
                            }, i.toString = function () {
                                return r
                            }, i
                            ...
                            o.setPixel = function (t, e, r) {
                                ...
                                t.writeString("GIF87a"), t.writeShort(n), t.writeShort(r), t.writeByte(128), t.writeByte(
                                    0), t.writeByte(0), t.writeByte(0), t.writeByte(0), t.writeByte(0), t.writeByte(255),
                                    t.writeByte(255), t.writeByte(255), t.writeString(","), t.writeShort(0), t.writeShort(
                                    0), t.writeShort(n), t.writeShort(r), t.writeByte(0);
                                var e = 2,
                                    i = a(e);
                                t.writeByte(e);
                                for (var o = 0; i.length - o > 255;) t.writeByte(255), t.writeBytes(i, o, 255), o +=
                                        255;
                            ...
                            var A = function (t) {
                                ...
                                return i.write = function (t, i) {
                                    ...
                                    for (; n + i >= 8;) e.writeByte(255 & (t << n | r)), i -= 8 - n, t >>>= 8 - n, r =
                                            0, n = 0;
                                    r |= t << n, n += i
                                }, i.flush = function () {
                                    n > 0 && e.writeByte(r)
                                    ...
                                    for (var e = 1 << t, n = (1 << t) + 1, r = t + 1, o = c(), a = 0; a < e; a += 1) o.add(
                                    ...
                                    for (l += 1; l < i.length;) {
                                        ...
                                        l += 1, o.contains(f + h) ? f += h : (s.write(o.indexOf(f), r), o.size() < 4095 &&
                                            (o.size() == 1 << r && (r += 1), o.add(f + h)), f = h)
                                    }
                                    return s.write(o.indexOf(f), r), s.write(n, r), s.flush(), u.toByteArray()
                                }, c = function () {
                                    var t = {}, e = 0,
                                        n = {};
                            ...
                            for (var i = d(t, e), o = 0; o < e; o += 1) for (var A = 0; A < t; A += 1) i.setPixel(A, o,
                                        n(A, o));
                            var a = p();
                            i.write(a);
                            for (var c = h(), u = a.toByteArray(), s = 0; s < u.length; s += 1) c.writeByte(u[s]);
                            c.flush();
                            var l = "";
                            return l += "<img", l += ' src="', l += "data:image/gif;base64,", l += c, l += '"', l +=
                                ' width="', l += t, l += '"', l += ' height="', l += e, l += '"', r && (l += ' alt="',
                                l += r, l += '"'), l += "/>"
                        };
                    return e
                }();
            ...
            function i(t, e) {
                var n = g(),
                    r = y[y.length - 1];
                if ("top" === t.insertAt) r ? r.nextSibling ? n.insertBefore(e, r.nextSibling) : n.appendChild(e) : n.insertBefore(
                        e, n.firstChild), y.push(e);
                else {
            ...
            function c(t, e) {
                ...
                if (e.singleton) {
                    var c = b++;
                    n = d || (d = A(e)), r = u.bind(null, n, c, !1), i = u.bind(null, n, c, !0)
                    ...
                    }) : (n = A(e), r = s.bind(null, n), i = function () {
                        o(n)
                    });
                return r(t),
                function (e) {
            ...
            t.exports = function (t, e) {
                ...
                e = e || {}, "undefined" == typeof e.singleton && (e.singleton = h()), "undefined" == typeof e.insertAt &&
                    (e.insertAt = "bottom");
                var i = r(t);
                return n(i, e),
                function (t) {
            ...
            var d = n(3).version,
                b = function (t) {
                    ...
                    return A(e, t), a(e, [{
                            ...
                            value: function (t) {
                                var e = this;
                                t && (this._config = t), (0, c.ready)(function () {
                                    e.formatConfig(), e.getTctipDom(), e.config.stat && e.stat()
                                })
                            }
                        }]), e
                }(g.
