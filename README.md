...
| 软件                                             | 简介                                | Windows | MacOS | Linux |
| ------------------------------------------------ | ----------------------------------- | ------- | ----- | ----- |
| [Ditto](https://ditto-cp.sourceforge.io/)        | 剪贴板工具，效率必备                | 💖       |       |       |
| [天若 OCR](https://tianruoocr.cn/)               | 文本识别                            | 💖       |       |       |
| [QuickLook](https://pooi.moe/QuickLook/)         | 空格预览文件电脑工具                | 💖       |       |       |
| [Quicker](https://getquicker.net/)               | 为常用操作建立捷径，让效率触手可及! | 💖       |       |       |
| [格式工厂](http://www.pcgeshi.com/download.html) | 音乐、视频、图片等格式转换软件      | 💖       |       |       |
